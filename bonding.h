...
// jungmin ---------------------------------------------------------------------
	//struct	delayed_work nlb_send_work;
	//struct 	delayed_work nlb_recv_work;
	struct	delayed_work nlb_check_work;
	struct 	delayed_work nlb_hello_work;
